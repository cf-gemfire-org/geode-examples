...
public class GatewayAuthInit implements AuthInitialize {
  ...
  public Properties getCredentials(Properties securityProps) throws AuthenticationFailedException {
    ...
    credentials.setProperty(USER_NAME, "cluster_operator_h2hqOQqOdtSPK33vJWQUbg");
    credentials.setProperty(PASSWORD, "aplZqVgrTDRwkVCs2Eqqg");
